    var rule = {
        ...
        class_url: '1&2&4&3&5',
        play_parse: true,
        lazy:'js:if(/m3u8|mp4/.test(input)){input}else{let purl=request("http://jx.realdou.cn/api/?key=FfeBSwPEyz1MBrTCvd&url="+input);input={jx:0,url:JSON.parse(purl).url,parse:0}}',
        limit: 6,
