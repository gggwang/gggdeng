{
  "站名": "臭蛋蛋",
  "主页url": "https://www.cddys.vip/",
  "二次截取":"class=\"module-item&&fixedGroup",           
  "数组": "<a&&no-referrer",
  "图片": "data-original=\"&&\"",
  "标题": "title=\"&&\"",
  "链接": "href=\"&&\"",
  ...
  "分类": "电影&电视剧&综艺&动漫",
  "分类值": "1&2&3&4",
  "分类url": "http://www.cddys.vip/vodshow/{cateId}-{area}--{class}-{lang}----{catePg}---{year}.html",
    
  "搜索模式": "1",
  "搜索url":"/vodsearch/-------------.html?wd={wd}",
  "搜索二次截取":"class=\"module-items&&fixedGroup",
  "搜索数组": "<a&&no-referrer",
  "搜索图片": "data-original=\"&&\"",
  "搜索标题": "title=\"&&\"",
  "搜索链接": "href=\"&&\"",
